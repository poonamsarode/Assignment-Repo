package kalyanJwellars.stepdefs;
...
public void search_result_is_displyed() {
    ...
    Assert.assertEquals("Online Jewellery Shopping India | Candere By Kalyan Jewellers |: majestic solitaire diamond ring", driver.getTitle());
